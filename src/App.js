...
function App() {
  ...
  return (
    <>
      <div style={{ backgroundImage: "url(https://cdn.prod.website-files.com/5a9ee6416e90d20001b20038/64c2218b914204c638d7ab63_-38.png)", height: "100vh", padding: "30px", backgroundSize: "cover" }}>
        <div className='main'>
          <button onClick={() => decorateFunction('bold')} style={{ display: "flex", justifyContent: "sp" }}>
